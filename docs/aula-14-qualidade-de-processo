...
| ---------------------- | ---------------------------------------------- | ----------------------------------------------------------- | ----------------------- |
| Recebimento da Demanda | Solicitação de nova funcionalidade ou correção | Registrar e organizar a demanda no Trello                   | Tarefa criada           |
| Análise dos Requisitos | Tarefa criada                                  | Identificar requisitos e definir o escopo da funcionalidade | Requisitos definidos    |
| Prototipação           | Requisitos definidos                           | Desenvolver ou atualizar protótipos no Figma                | Protótipo validado      |
| Desenvolvimento        | Protótipo e requisitos aprovados               | Implementar a funcionalidade no sistema                     | Código desenvolvido     |
| Controle de Versão     | Código desenvolvido                            | Realizar commit e push utilizando Git                       | Código versionado       |
